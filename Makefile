...
DZ80OBJS = $(OBJDIR)/dz80.o $(OBJDIR)/common.o $(OBJDIR)/dz80pass1.o $(OBJDIR)/dz80pass2.o $(OBJDIR)/dz80table.o $(OBJDIR)/analyzez80.o
...
WINDZ80OBJS = $(OBJDIR)/dz80.obj $(OBJDIR)/common.obj $(OBJDIR)/dz80pass1.obj $(OBJDIR)/dz80pass2.obj $(OBJDIR)/dz80table.obj $(OBJDIR)/analyzez80.obj
...
$(OBJDIR)/dz80.o: dz80.c defs.h dz80.h dispass0.c dz80pass1.h dz80pass2.h dispass3.c dz80table.h analyze.h common.h
	$(CC) $(CFLAGS) -c $< -o $@
...
$(OBJDIR)/analyzez80.o: analyzez80.c defs.h d52.h analyze.h d52pass2.h
	$(CC) $(CFLAGS) -c $< -o $@
...
$(OBJDIR)/d48.obj: d48.c defs.h d48.h dispass0.c d48pass.h dispass3.c d48table.h analyze.h common.h
	$(WINCC) -o $@ $(WINCFLAGS) -c $<

$(OBJDIR)/dz80.obj: dz80.c defs.h dz80.h dispass0.c dz80pass1.h dz80pass2.h dispass3.c dz80table.h common.h
	$(WINCC) -o $@ $(WINCFLAGS) -c $<
...
$(OBJDIR)/analyzez80.obj: analyzez80.c defs.h d52.h analyze.h d52pass2.h
	$(WINCC) -o $@ $(WINCFLAGS) -c $<
